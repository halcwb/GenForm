...
let clientPath = Path.getFullName "./src/Informedica.GenForm.Client"
let clientDeployPath = Path.combine clientPath "deploy"
let deployDir = Path.getFullName "./deploy"
let dataDir = Path.getFullName "./data"
let serverDataPath = Path.combine serverPath "data"
